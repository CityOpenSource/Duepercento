...
<html lang="it">
    ...
    <head>
        ...
        <link rel="icon" type="image/png" sizes="36x36"  href="<?php echo get_template_directory_uri();?>/favicons/android-icon-36x36.png">
        <link rel="icon" type="image/png" sizes="48x48"  href="<?php echo get_template_directory_uri();?>/favicons/android-icon-48x48.png">
        <link rel="icon" type="image/png" sizes="72x72"  href="<?php echo get_template_directory_uri();?>/favicons/android-icon-72x72.png">
        <link rel="icon" type="image/png" sizes="96x96"  href="<?php echo get_template_directory_uri();?>/favicons/android-icon-96x96.png">
        <link rel="icon" type="image/png" sizes="144x144"  href="<?php echo get_template_directory_uri();?>/favicons/android-icon-144x144.png">
                                    ...
                                    <div class="it-brand-wrapper d-flex flex-row">                        
                                        <a href="https://creativitacontemporanea.cultura.gov.it/" title="Vai alla homepage" target="_blank" rel="noopener" class="d-md-inline-block d-none">
                                            <svg height="82" class="icon" aria-hidden="true" style="width:305px!important">
                                                <image style="width:305px!important" href="<?php echo get_template_directory_uri();?>/svg/lm-dgcc-bianco.svg" />
                                            </svg>
                                        </a>
                                        <a href="/" title="Vai alla homepage">
                                            <svg height="82" class="icon" aria-hidden="true">
                                                <image xlink:href="<?php echo get_template_directory_uri();?>/svg/lm-2x100-bianco.svg" />
                                            </svg>
                                        </a>
                                    </div>
                                            ...
                                            <a href="/" class="logo-hamburger"> 
                                                <div class="it-brand-text">
                                                    <div class="it-brand-title">
                                                        <img class="img-fluid mt-5" src="<?php echo get_template_directory_uri();?>/images/lm-2x100-blu.png" />
                                                    </div>
                                                </div>
                                            </a>
