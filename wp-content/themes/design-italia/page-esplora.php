                        ...
                        <nav class="pagination-wrapper justify-content-center" aria-label="Navigazione centrata">
                            ...
                            <li class="page-item disabled">
                                ...
                                <svg class="icon icon-primary">
                                    <use href="<?php echo get_template_directory_uri();?>/svg/sprites.svg#it-chevron-left"></use>
                                </svg>
                            ...
                            <li class="page-item">
                                ...
                                <svg class="icon icon-primary">
                                    <use href="<?php echo get_template_directory_uri();?>/svg/sprites.svg#it-chevron-right"></use>
                                </svg>
                                </a>
                            </li>
                            </ul>
